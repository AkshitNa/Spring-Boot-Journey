...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student(1, "Akshit", "Nautiyal"));
        students.add(new Student(2, "Saumya", "Budakoti"));
        students.add(new Student(3, "Saurab", "Negi"));
        students.add(new Student(4, "Plakchha", "Negi"));
